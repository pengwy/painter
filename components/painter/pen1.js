...
export default class Painter {
   ...
   _drawAbsImage(view) {
        ...
        if (view.css && view.css.mode === 'scaleToFill') {
            this.drawImage(this.ctx,view.url, -(width / 2), -(height / 2), width, height);
        } else {
            this.drawImageCli(this.ctx,view.url, startX, startY, rWidth, rHeight, -(width / 2), -(height / 2), width, height);
        }
        this.ctx.restore();
        this._doBorder(view, width, height);
    }
